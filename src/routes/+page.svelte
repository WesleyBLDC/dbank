...
<div class="hero min-h-screen bg-base-200">
    <div class="hero-content text-center">
        <div class="max-w-md">
            <h1 class="text-5xl font-bold">Welcome to d.bank!</h1>
            <p class="py-6">d bank that's truly...<em>decentralized</em>.</p>
            ...
            <div data-sveltekit-preload-data="tap" data-sveltekit-preload-code="hover">
                ...
                <a href="/login" class="btn btn-outline">Existing User Login</a>
            </div>
        </div>
    </div>
</div>
