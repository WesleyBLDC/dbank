<script>
    ...
    const CONVERSION_RATE = 0.0078 // 1 KSH to USDC
    ...
    function calculateUSDC() {
        usdcAmount = (parseFloat(kshAmount) * CONVERSION_RATE).toFixed(2)
    }
        ...
        {#if isSuccess}
            <div class="flex flex-col items-center justify-center p-6">
                ...
                <p class="text-center text-lg font-semibold">
                    Successfully bought {usdcAmount} USDC for<br />{successPhoneNumber}
                </p>
